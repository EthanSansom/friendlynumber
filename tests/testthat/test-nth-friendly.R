...
test_that("`nth_friendly_safe()` enforces input types", {
  ...
  expect_input_error(nth_friendly_safe(int, zero = twochr))
  expect_input_error(nth_friendly_safe(int, na = int))
  expect_input_error(nth_friendly_safe(int, na = twochr))
  expect_input_error(nth_friendly_safe(int, nan = int))
  expect_input_error(nth_friendly_safe(int, nan = twochr))
  expect_input_error(nth_friendly_safe(int, inf = int))
  expect_input_error(nth_friendly_safe(int, inf = twochr))
  expect_input_error(nth_friendly_safe(int, negative = int))
  expect_input_error(nth_friendly_safe(int, negative = twochr))
  expect_input_error(nth_friendly_safe(int, bigmark = int))
